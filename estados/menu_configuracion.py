...
class MenuConfiguracion(Estado):
    """Estado que implementa el menú de configuración del juego."""
    def __init__(self, juego):
        ...
        # Obtener gestor de fuentes y configuración
        ...
        self.opcion_fullscreen = OpcionBinaria(
            ...
            "Pantalla Completa",
            font.medium,
            self.config.get("pantalla_completa")
        )
        ...
        # Número elementos menú para mostrar hint seleccionado
        self.elementos_navegables = 4

        # Índice de navgegación elementos
        self.indice_nav = 0

        #Cooldown navegación/selección
        self.cooldown_nav = 0
        self.delay_nav = 0.15
    ...
    #Devolver índice elemento bajo el cursor o seleccionado
    ...
    def actualizar(self, dt, acciones):
        ...
        # Posición del ratón escalada y estado del click
        ...
        # Detectar si el ratón se movió respecto al frame anterior
        self.mouse_moviendose = pos_mouse_escalado != self.prev_mouse_pos
        self.prev_mouse_pos = pos_mouse_escalado

        # Si el ratón está sobre un elemento, actualizar hovering
        ...
        # Inputs teclado
        up = acciones.get("arrowUp")
        down = acciones.get("arrowDown")
        left = acciones.get("arrowLeft")
        right = acciones.get("arrowRight")
        enter = acciones.get("enter")
        back = acciones.get("back")

        # Si se mueve ratón ignorar inputs de teclado en el frame
        ...
        # Interacción ratón según hover elemento
        if self.indice_nav == 0:
